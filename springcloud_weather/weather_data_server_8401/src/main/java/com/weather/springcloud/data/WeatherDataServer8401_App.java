package com.weather.springcloud.data;
...
@ComponentScan(basePackages = {"com.weather.springcloud.data","com.weather.springcloud.api.service"})
public class WeatherDataServer8401_App {

    public static void main(String[] args) {
        SpringApplication.run(WeatherDataServer8401_App.class,args);
    }
}
